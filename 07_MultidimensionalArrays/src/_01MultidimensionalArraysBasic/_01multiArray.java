...
public class _01multiArray {
    ...
    Multidimensional Arrays 
        multi-dimensional arrays in java is an array of arrays that allows data to store in a tabular form such as row or column. Its is commonly used to represent metrics, grid, and table in a program.
